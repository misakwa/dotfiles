...
{LENS}. Other critics are covering the other lenses in parallel. Go deep on yours; only raise findings outside it if they are serious and would otherwise be missed.
